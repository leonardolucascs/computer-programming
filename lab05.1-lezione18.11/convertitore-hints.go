	...
	for {
		...
		switch operazione {
			...
			if numeroInizializzato {
				...
				var b int
				fmt.Scan(&b)
				numero = ConvertiAdAlfanumericoIn_B_b(numero, b)
...
func ConvertiAdAlfanumericoIn_B_b(n string, b int) string { ... }
func ConvertiDaInteroInB_10AdAlfanumericoInB_b(v int, b int) (n string) { ... }
...
func ConvertiAdAlfanumericoIn_B_b(n string, b int) string {
	...
	return "BASE:" +
		ConvertiDaInteroInB_10AdAlfanumericoInB_b(b, 10) +
		"_" +
		"VALORE:" +
		ConvertiDaInteroInB_10AdAlfanumericoInB_b(ConvertiAlfanumericoInB_b_AInteroInB_10(estraiVALORE(n), ConvertiAlfanumericoInB_b_AInteroInB_10(estraiBASE(n), 10)), b)
